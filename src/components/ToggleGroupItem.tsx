...
const ToggleGroupItem = ({
  ...
  return (
    <ToggleGroup.Item
      value={value}
      tabIndex={tabIndex}
      className="group rounded-xl bg-gray-300 p-0.5 text-gray-500 transition-colors hover:bg-gray-300 focus:bg-suit focus:outline-none data-[state=on]:bg-suit data-[state=on]:text-blue-850"
      onClick={onClick}
    >
