      ...
      <div className="flex items-start gap-6">
        ...
        >
          ...
          <div className="rounded-md border border-gray-150 bg-gray-50 p-3 text-sm text-gray-500">
            ...
            <strong className="font-medium text-gray-600">수신자</strong>의
            이름이 포함되어 있으면 더 정확한 답장을 생성할 수 있습니다.
          </div>
          <div className="prose text-sm text-slate-500">
            ...
            <p>
              ...
              marketing and social media ideas and would appreciate your
              feedback. Should we contact Emily for the launch event? Can we
              discuss this over coffee next week?
            </p>
